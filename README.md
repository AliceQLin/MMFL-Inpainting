...
<div align=center><img src="./figure/Fig1.PNG" width="70%" height="70%" ></div>

-------------

## Model Architecture
<div align=center><img src="./figure/network.PNG" width="70%" height="70%" ></div>

### Image-Adaptive Word Demand
<div align=center><img src="./figure/WDM.PNG" width="70%" height="70%" ></div>

### Text Guided Attention Loss
<div align=center><img src="./figure/attnloss.PNG" width="70%" height="70%" ></div>

-------------

## Datasets
We use [CUB-200-2011](http://www.vision.caltech.edu/visipedia/CUB-200.html), [Flowers](https://www.robots.ox.ac.uk/~vgg/data/flowers/102/) and [CelebA](http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html) datasets.

-------------

## Text Guided Controllable Face Inpainting
<div align=center><img src="./figure/faceInpainting.PNG" width="70%" height="70%" ></div>

-------------

## Acknowledgments
We benefit a lot from [CSA](https://github.com/Yukariin/CSA_pytorch) and [AttnGAN](https://github.com/taoxugit/AttnGAN).
